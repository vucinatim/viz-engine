  ...
  render: ({ frameContext, layer, settings }) => {
    ...
    return {
      ...
      parameters: {
        ...
        gravityStrength: Math.max(0, asNumber(physics.gravityStrength, 9.8)),
        ...
        rotationX:
          frameContext.timeInSeconds * asNumber(rotation.rotationSpeedX, 0),
        rotationY:
          frameContext.timeInSeconds * asNumber(rotation.rotationSpeedY, 1),
        rotationZ:
          frameContext.timeInSeconds * asNumber(rotation.rotationSpeedZ, 0),
      },
