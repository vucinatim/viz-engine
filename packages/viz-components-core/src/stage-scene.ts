  ...
  render: ({
    ...
    return {
      ...
      parameters: {
        ...
        cinematicLookAt: readVector3(
          camera.cinematicLookAt,
          [0, 5, 0],
        ),
        ...
        shaderWallScale: clamp(
          asNumber(shaderWall.scale, 2),
          0.5,
          4,
        ),
        ...
        shaderWallColorSpeed: clamp(
          asNumber(shaderWall.colorSpeed, 3),
          0,
          3,
        ),
        shaderWallTravelSpeed: clamp(
          asNumber(shaderWall.travelSpeed, 1),
          0,
          3,
        ),
        shaderWallBrightness: clamp(
          asNumber(shaderWall.brightness, 2),
          0,
          5,
        ),
        ...
        ambientIntensity: clamp(
          asNumber(lighting.ambientIntensity, 1),
          0,
          5,
        ),
        ...
        laserRotationSpeed: clamp(
          asNumber(lasers.rotationSpeed, 1),
          0,
          3,
        ),
        ...
        movingLightsEnabled: asBoolean(
          movingLights.enabled,
          true,
        ),
        movingLightMode: readMode(movingLights.mode, 4),
        movingLightColorMode: asString(
          movingLights.colorMode,
          "multi",
        ),
        movingLightColor: asString(
          movingLights.singleColor,
          "#ffffff",
        ),
        movingLightIntensity: clamp(
          asNumber(movingLights.intensity, 5),
          0,
          20,
        ),
        movingLightSpeed: clamp(
          asNumber(movingLights.speed, 1),
          0,
          3,
        ),
        ...
        stageWashIntensity: clamp(
          asNumber(stageWash.intensity, 5),
          0,
          50,
        ),
        strobesEnabled: asBoolean(strobes.enabled, true),
        strobeIntensity: clamp(
          asNumber(strobes.intensity, 500),
          0,
          1_000,
        ),
        strobeFlashRate: clamp(
          asNumber(strobes.flashRate, 0.3),
          0,
          1,
        ),
        blindersEnabled: asBoolean(blinders.enabled, true),
        blinderMode: asString(blinders.mode, "controlled"),
        blinderIntensity: clamp(
          asNumber(blinders.intensity, 0),
          0,
          1,
        ),
        overheadBlinderEnabled: asBoolean(
          overheadBlinder.enabled,
          true,
        ),
        ...
        accentLightsEnabled: asBoolean(
          accentLights.enabled,
          true,
        ),
        accentLight1Color: asString(
          accentLights.light1Color,
          "#ff00ff",
        ),
        accentLight2Color: asString(
          accentLights.light2Color,
          "#00ffff",
        ),
